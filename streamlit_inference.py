...
class Inference:
    ...
    def inference(self):
        ...
        if self.st.sidebar.button("Start"):
            ...
            # Check if the app is running in a local environment and only call cv2.destroyAllWindows() if true
            if os.environ.get("DISPLAY", "") != "":  # Environment check for GUI support
                cv2.destroyAllWindows()  # Destroy all OpenCV windows if running locally
